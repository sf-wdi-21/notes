...
If you would like to load, execute, and save `.sql` files a safe sandbox environment, head on over to this [online SQL interpreter](http://kripken.github.io/sql.js/GUI/). It's handy!
