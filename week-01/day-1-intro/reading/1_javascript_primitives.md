...
Open your Chrome Browser, and go to the developer console. You can do this by either using the keyboard shortcut `OPTION-COMMAND-J`, or clicking on: `View >  Developer > Javascript Console` in your browsers menu bar. [JS For Cats: Instructions](http://jsforcats.com/#basics).
